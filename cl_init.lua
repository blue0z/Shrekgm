...
draw.SimpleText( string TimeLeft, string font="DermaDefault", number x=0, number y=0, table color=Color( 0, 0, 0, 255 ), number xAlign=TEXT_ALIGN_LEFT, number yAlign=TEXT_ALIGN_TOP ) -- Draw text
end )
